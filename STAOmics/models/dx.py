...
def integration_consistency(
        model: STAOmicsModel, adatas: Mapping[str, AnnData],
    ...
    **kwargs
        ...
        :func:`STAOmics.data.metacell_corr`
    ...
    for k, adata in adatas.items():
        adata.obsm["X_STAOmics"] = model.encode_data(k, adata)
    ...
    for n_meta in (10, 20, 50, 100, 200):
        ...
        corr = metacell_corr(
            *adatas.values(), skeleton=graph,
            use_rep="X_STAOmics", n_meta=n_meta, **kwargs
        )
